...
public class ProductBenefitsAdaptor extends RecyclerView.Adapter<ProductBenefitsAdaptor.ViewHolder> {
    ...
    @NonNull
    @Override
    public ProductBenefitsAdaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType){
...
//                title.setLayoutParams(layoutParams);
    ...
    @Override
    public void onBindViewHolder(@NonNull ProductBenefitsAdaptor.ViewHolder holder, int position) {
        switch (productBenefitsModelList.get(position).getType()){
            case ProductBenefitsModel.BENEFITS_TITLE:
