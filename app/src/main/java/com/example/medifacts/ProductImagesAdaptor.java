...
public class ProductImagesAdaptor extends RecyclerView.Adapter<ProductImagesAdaptor.Viewholder> {
    ...
    @NonNull
    @Override
    public ProductImagesAdaptor.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ProductImagesAdaptor.Viewholder holder, int position) {
